    ...
    return (
        <section className="flex justify-center items-end h-[1080px] w-full bg-[black] relative">
          ...
          <Header/>
              ...
              <div
                className="bg-gradient-to-r w-[350px] h-[150px] absolute z-2 left-[15%] bottom-0 rounded-[50%] blur-[220px] bg-img1"
                style={{
             ...
             ></div>
              ...
              <div
                className="bg-gradient-to-r absolute z-2 left-[23%] top-[-10%] w-[350px] h-[250px] blur-[180px] rounded-[50%] bg-img2"
                style={{
             ...
             ></div>
               ...
               {/* <div>
                 <Image
                          ...
                          height={1016}
                          alt='moon'
                          className=" right-0 top-[5%] z-1 fixed sct1-bg"
                          priority
                        />
                 </div> */}
             ...
             <div  className="flex flex-col  justify-between h-[894px]  w-[92%] absolute z-[2]">
                ...
                <div data-aos="fade-right"
                 data-aos-duration="3000" className=" w-[92%] h-[492px] flex flex-col gap-[36px]">
                    <h1
     ...
     data-aos-anchor-placement="bottom-bottom"
                    className="flex flex-col justify-center gap-[20px] w-[564px] h-[192px] opacity-35 rounded-[91px]  text-[white] bg-[linear-gradient(to_right,_rgba(80,20,70,1),_rgba(150,50,20,1),_rgba(120,25,35,1))]">
                        <span className="text-[64px] font-[600] span1">10,873</span>
                        <span className="text-[24px] font-[400] span2">LLM models</span>
                    </button>

                       <button data-aos="fade-up"
     data-aos-anchor-placement="bottom-bottom"  data-aos-duration="1000"  className="flex flex-col justify-center gap-[20px] w-[564px] h-[192px] opacity-35 rounded-[91px] text-[white] bg-[linear-gradient(to_right,_rgba(80,20,70,1),_rgba(150,50,20,1),_rgba(120,25,35,1))]">
                      ...
                      <button data-aos="fade-up"
     data-aos-anchor-placement="bottom-bottom"  data-aos-duration="2000" className="flex flex-col justify-center gap-[20px] w-[564px] h-[192px] opacity-30 rounded-[91px] text-[white] bg-[linear-gradient(to_right,_rgba(80,20,70,1),_rgba(150,50,20,1),_rgba(120,25,35,1))]">
