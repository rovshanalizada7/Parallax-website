        ...
        <section className='flex items-center h-[1080px]  w-full bg-[black] relative sct3 overflow-hidden'>
           ...
           <div
            ...
            ></div>
              ...
              >
                <Image src='/imgs/image20.png' width={260} height={170} className='w-full h-full object-cover' alt='image20' />
              </div>


           <div data-aos="fade-up" data-aos-duration="1000" className='flex justify-end h-[423px] w-[1229px] z-1 '>
