...
const Section3 = () => {
  ...
  return (
    <section className="flex items-center h-[1080px]  w-full bg-[black] relative sct3 overflow-hidden">
      <div
        className="absolute z-2 left-20 top-0 transition-transform duration-75 ease-linear"
        style={{
      ...
      <div
        ...
        className="flex justify-end h-[423px] w-[1229px] z-1 "
      >
        <div className="h-[423px] w-[1149px] flex flex-col justify-between sct3-content ">
          <h1 className="text-[64px] text-[#FFFFFF] space-y-4 font-[500] leading-[1.1]">
            Crowdsourcing our collective <br /> intelligence to build the best
            AI
          </h1>

          <div>
            <p className="text-[24px] text-[white] leading-[32px] font-[Inter] font-[400]">
              Open source AI has been lagging behind the likes of Google and
              OpenAI by billions of dollars.
            </p>
            <p className="text-[24px] text-[white] leading-[32px] font-[Inter] font-[400] mt-4">
              {" "}
