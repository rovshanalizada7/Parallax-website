...
const Section4 = () => {
  ...
  return (
    <section
      id="section4"
      className="h-[1000px] w-full bg-[black] flex justify-center items-center z-3 relative sct4"
    >
      <div
        className="absolute bottom-[-28%] z-1 left-[20%] transition-transform duration-75 ease-linear"
        style={{
          transform: `translateY(-${offset}px)`,
        }}
      >
        <Image src="/imgs/Group25.png" width={226} height={750} alt="image25" />
      </div>

      <div
        data-aos="fade-up"
        data-aos-duration="2000"
        className="h-[943px] w-[1760px]  flex flex-col gap-[32px] table-div"
      >
        <div className="h-[79px] w-full flex justify-between sct4-div">
          <span className="text-[64px] font-[500] text-[white]">
            LLM Leaderboard
          </span>
          <div
        ...
        <p className="text-[white] text-[24px]">
          ...
          to test LLMs on a large number of different evaluation tasks. <br />
