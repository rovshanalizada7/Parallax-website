...
const Footer = () => {
  return (
   <footer className='h-[1040px] w-full bg-[black] overflow-hidden'>
    <div data-aos="zoom-in" data-aos-durarion="2000" className='h-[528px] w-full  flex justify-center items-center '>
