...
const Footer = () => {
  return (
    <footer className="h-[1040px] w-full bg-[black] overflow-hidden relative z-3">
      <div
        data-aos="fade-up-left"
        className="h-[528px] w-full  flex justify-center items-center "
      >
        <h1 className="font-inter font-normal text-[32px] leading-[32px] text-white">
          Join our community and harvest $SALT
        </h1>
      </div>

      <div
        className="h-[512px] w-full flex justify-center items-end  bg-cover bg-no-repeat bg-center"
        style={{ backgroundImage: "url('/imgs/nasa.png')" }}
      >
        <div className="h-[106px] w-[90%] mb-10 flex flex-col justify-between items-center ">
          ...
          <div className="h-[36px] w-full flex justify-between items-center footer-bottom">
            ...
            <div className="w-[296px] h-[15px] flex justify-between items-center footer-spans">
              <span className="font-inter font-normal text-[12px] text-[#8E8E8E]">
                Terms of Use
              </span>
              <span className="font-inter font-normal text-[12px] text-[#8E8E8E]">
                Privacy Policy
